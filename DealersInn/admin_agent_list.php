...
<?php include("headerAdmin.php") ?>
        ...
        <div class="row">
          ...
          <div class="column" style="float: left; width:68%; padding:40px; height:auto;">
              ...
              <br><br>
                                    ...
                                    LEFT OUTER JOIN user_company_details ON user_company_details.user_id=users.user_id
          ...
          <br>
              ...
              <?php
               ...
               $aquery = "SELECT * FROM users WHERE status='0' ";
                ...
                if ($numrows == 0) {
                 echo "<h4> You have no  requests to activate account.</h4>";
                ...
                while($arow = mysqli_fetch_array($aresult))
                {
                  ...
                  echo " <h3>".$arow["email"]."</h3> ".$arow["fname"]."  ".$arow["lname"]."  sent you request to activate an account <br>";
                  
                  ?>
                  <div style=" display: inline-grid">
                  <form action='admin_agent_list.php?id=<?php echo $arow['user_id'] ?>' method='post'>
        ...
        $numrows = mysqli_num_rows($eresult);
         ...
         while($arow = mysqli_fetch_array($eresult)){
              ...
              "
                    ...
                    Now,you can Login here http://localhost/DEALERAMNAS/signin.php
                    <br> 
