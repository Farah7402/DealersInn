          ...
          <div class="col-md-7 col-lg-8">
            <div>
                                      ...
                                      SELECT
                                            ...
                                            /*10*/        property_types.property_type
...
,MAX(IF(addition_features.feature = 'Other', property_additional_features.feature, NULL)) as `View`
  /*25*/
,MAX(IF(addition_features.feature = 'Kitchen', property_additional_features.feature, NULL)) as `View`
                ...
                <div class="card">
                  ...
                  <div class="media">
                    ...
                    <div class="media-body">
                      <h4 class="media-heading"><a href="agent.html"><?php echo $row[4]?> <?php echo $row[5]?></a></h4>
      ...
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
             ...
             <?php echo $row[24]?>
              ...
              <ul class="checked_list feature-list">
                <li><strong>Build Year:</strong> <?php echo $row[16]?></li>
                <li><strong>Electricity Meter:</strong><?php echo $row[17]?></li>
                <li><strong>Gas Meter:</strong><?php echo $row[18]?></li>
                <li><strong>View:</strong><?php echo $row[19]?></li>
                <li><strong>Furnished:</strong><?php echo $row[20]?></li>
                <li><strong>Floor:</strong><?php echo $row[21]?></li>
              </ul>
        
              <h3 class="headline">Property Features</h3>
              <ul class="checked_list feature-list">
                <li><?php echo $row[22]?></li>
                <li><?php echo $row[23]?></li>
              </ul>
