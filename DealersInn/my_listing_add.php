...
//echo $_SESSION['pid'];
  if(isset($_POST['btnSubmit']))
  {
   ...
   // $upic=null;
    ...
    $uuimg= $_FILES['fileToUpload']['name'][$key];  
	...
	if ($uuimg!="") 
	{
		...
		move_uploaded_file($_FILES['fileToUpload']['tmp_name'][$key],"img/property/".$pic);
        mysqli_query($Conn,"insert into p_images values ('$MaxID','$a','$pic')");    
		$a++;
}}
		}
								...
								<div class="form-group">
									...
									<div class="form-group">
										...
										<div>
											...
											<div class="radio radio-inline">
												<input <?php if($salerent==3) { ?>checked <?php } ?> id="Sold out" type="radio" name="rdoPropertyFor" value="3" >
												<label for="Sold out">
													Sold out
												</label>
											...
											<div class="radio radio-inline">
												<input <?php if($salerent==4) { ?>checked <?php } ?> id="Rent out" type="radio" name="rdoPropertyFor" value="4" >
												<label for="Rent out">
													Rent out
												</label>
									...
									<div class="form-group">
										...
										<span style="color: red; font-size: 20px">*</span>
										<input  value="<?php echo $price; ?>" type="number"  name="txtPrice" class="form-control form-control-lg" pattern="[0-9]"  placeholder="Price (IN PKR RS.)" required="">
									</div>
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
