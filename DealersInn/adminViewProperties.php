...
$from = date('Y-m-d', strtotime(str_replace('/', '-', $_POST["date_from"])));
    ...
    // using concat mysql function
       if( $pmin != "" || $pmax != "" || $name != "" || $type != "" || $property_for != "" || $city != "" || $from != "" || $room != "" ){
...
property_types='$type' OR propert_sale_rent.type='$property_for' OR  cities.city_name ='$city' OR
...
<?php include("headerAdmin.php") ?>
        ...
        <form action="adminViewProperties.php" method="post">
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="form-group">
                ...
                <option value="selected">Sahiwal</option>
...
<!--div class="col-sm-2">
<div id="show"><input type="button" value="More Option" class="btn btn-lg btn-primary btn-block"></div>
</div-->
<br>
  ...
  <div class="search-form">
    <div class="card"-->
      <div class="row">
        ...
        <div class="col-lg-3">
          <div class="form-group">
            <select class="form-control form-control-lg ui-select" data-placeholder="Property Type" name="property_type" >
            <option>Property Type</option>
            <option value="Flat">Flat</option>
            <option value="Home">Home</option>
            <option value="Apartmet">Apartment</option>
            <option value="Upper Poprtion">Upper Portion</option>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="form-group">
             <input type="text" class="form-control form-control-lg" placeholder="Uploaded By" name="name">
              </div>
            </div>
                ...
                <div class="row">
                  <div class="col-lg-5">
                    <div class="item-image">
                     ...
                     <a href="admin_property_details_plot.php?id=<?php echo $row['property_id']; ?>">
                  ...
                  <div class="col-lg-7">
                   <div class="item-info">
                    <h3 class="item-title"> <a href="admin_property_details_plot.php?id=<?php echo $row['property_id']; ?>">Price:&nbsp;<?php echo $row[4]; ?><br/><?php echo $row[2]; ?>   </a> </h3>
                ...
                <div class="row">
                  <div class="col-lg-5">
                    <div class="item-image">
                     ...
                     <a href="admin_property_details_home.php?id=<?php echo $row['property_id']; ?>">
                      <img src="img/demo/property/2.jpg" class="img-fluid" alt="">
                      <div class="item-badges">
                  ...
                  <div class="col-lg-7">
                   <div class="item-info">
                   <h3 class="item-title"> <a href="admin_property_details_home.php?id=<?php echo $row['property_id']; ?>"> Price:&nbsp;<?php echo $row[4]; ?><br/><?php echo $row[2]; ?>   </a> </h3>
                    <div class="item-location"><i class="fa fa-map-marker"></i><?php echo $row[8]; ?></div>
                    <div class="item-details-i"> <span class="bedrooms" data-toggle="tooltip" title="Bedrooms"> <?php echo $row[14]; ?> <i class="fa fa-bed"></i></span> <span class="bathrooms" data-toggle="tooltip" title=" Bathrooms"> <?php echo $row[15]; ?> <i class="fa fa-bath"></i></span> </div>
