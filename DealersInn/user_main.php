                                             ...
                                             /*3*/         property_types.types,
                                              ...
                                              /*7*/        property.address,
                                               ...
                                               /*9*/       property.property_description,
                                                ...
                                                /*11*/     propert_sale_rent.type,
                                              /*12*/       property.submitted_by,
                                             /*13*/        property_types.property_type
/*14*/
                ...
                <div class="row">
                  <div class="col-lg-5">
                    <div class="item-image">
                     ...
                     <a href="user_view_property_plot.php?id=<?php echo $row['property_id']; ?>">
                      <img src="img/demo/property/2.jpg" class="img-fluid" alt="">
                      <div class="item-badges">
                     
                      <div class="item-badge-right">For <?php echo $row[11]; ?></div>
                      </div>
                  ...
                  <div class="col-lg-7">
                   <div class="item-info">
                    <h3 class="item-title"> <a href="user_view_property_plot.php?id=<?php echo $row['property_id']; ?>">Price:<?php echo $row[4]; ?><br/><?php echo $row[2]; ?>   </a>
                ...
                <div class="row">
                  <div class="col-lg-5">
                    <div class="item-image">
                     ...
                     <a href="user_view_property_home.php?id=<?php echo $row['property_id']; ?>">
                      <img src="img/demo/property/2.jpg" class="img-fluid" alt="">
                      <div class="item-badges">
                  ...
                  <div class="col-lg-7">
                   <div class="item-info">
                   <h3 class="item-title"> <a href="user_view_property_home.php.php?id=<?php echo $row['property_id']; ?>"> Price:<?php echo $row[4]; ?><br/><?php echo $row[2]; ?>   </a> </h3>
                    <div class="item-location"><i class="fa fa-map-marker"></i><?php echo $row[8]; ?></div>
