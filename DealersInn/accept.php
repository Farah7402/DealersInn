...
<?php include("header.php") ?>
        ...
        <div class="row">
          ...
          <div class="column" style="float: left; width:68%; padding:50px; height:auto;">
        ...
        <div class="column" style="float: right; width:30%; padding:25px; height:auto; border: solid; border-width:1px ">
          ...
          <br>
              ...
              <?php
               $aquery = "SELECT users.fname,users.lname,friends_list.friend_id,friends_list.user_id FROM friends_list INNER JOIN users ON users.user_id=friends_list.user_id
      ...
      if (isset($_POST['reject'])) 
{
  ...
  $bquery ="DELETE from friends_list  WHERE user_id=".$_GET["id"]." AND friend_id=".$_SESSION["UserID"]."";
  $bresult = mysqli_query($Conn,$bquery);
}
