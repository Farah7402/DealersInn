...
GROUP BY property.property_id
             ...
             <?php echo $row[3]?><br>
              ...
              <ul class="checked_list feature-list">
                <li><strong>Build Year:</strong> <?php echo $row[13]?></li>
                <li><strong>Electricity Meter:</strong><?php echo $row[14]?></li>
                <li><strong>Gas Meter:</strong><?php echo $row[15]?></li>
                <li><strong>View:</strong><?php echo $row[16]?></li>
                <li><strong>Furnished:</strong><?php echo $row[17]?></li>
                <li><strong>Floor:</strong><?php echo $row[18]?></li>
              </ul>
